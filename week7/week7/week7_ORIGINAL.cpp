/******************************************************************************
 * File Name: week7_ORIGINAL.cpp
 * Program Author: Daniel Hyde
 * Student ID: ********
 * Project Name: worksheets
 * Course Code: UFCFK4-30-2
 * Date Created: 22 October 2016
 *
 * Description: This program is designed as a tool to learn about the tools
 *              available for software testing within Visual Studios.
 * NOTE:        This is the original code provided to debug. week7.cpp
 *              contains the file AFTER the debugging process has been
 *              completed.
 *****************************************************************************/
/* Include section
...
{
	int comb = factorial(n) / factorial(k) * factorial(n - k); return comb;
}
